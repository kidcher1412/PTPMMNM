...
class Coffin(Entity, Monster):
	def __init__(self, pos, groups, path, collision_sprites, player, create_item):
...
class Cactus(Entity, Monster):
	def __init__(self, pos, groups, path, collision_sprites, player, create_bullet,create_item):
		super().__init__(pos, groups, path, collision_sprites,create_item)
		self.player = player
